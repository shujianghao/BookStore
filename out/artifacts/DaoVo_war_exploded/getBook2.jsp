...
<%
    ...
    String categoryID = request.getParameter("id1");
...
</h4><p><%=rs.getString("BookDescription")%></p>
    <p><a href="servlets/CarServlet?action=add&name=<%=rs.getString("BookName")%>" class="btn btn-primary" role="button">加入购物车</a> <a href="#" class="btn btn-default" role="button">查看详情</a>
    </p>
</div></div> </div><%
    }
    pstat.close();
