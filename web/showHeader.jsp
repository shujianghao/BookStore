        ...
        <div class="am-container header">
            <ul class="message-l">
                <div class="topMessage">
                    <div class="menu-hd">
                        <span style="font-family:华文新魏;font-size:20px">欢迎来历会员<span style="font-family:华文新魏;font-size:20px;color: lightblue"><%=name%></span><span style="font-family:华文新魏;font-size:20px;color:#b33951">来历书城</span>
                        <a href="servlets/LogoutServlet"><span style="font-family:华文新魏;font-size:20px;color:#2c666e">&nbsp;&nbsp;&nbsp;注销</span></a>
                    </div>
                </div>
            </ul>
            <ul class="message-r">
                ...
                <div class="topMessage my-shangcheng">
                    <div class="menu-hd MyShangcheng"><a href="order.jsp" target="_top"><i class="am-icon-user am-icon-fw"></i>我的订单</a></div>
                </div>
...
<div class="shopNav">
    <div class="slideall" style="height: auto;">
        ...
        <div class="nav-cont">
            <ul>
                <li class="index"><a href="getBook.jsp">首页</a></li>
